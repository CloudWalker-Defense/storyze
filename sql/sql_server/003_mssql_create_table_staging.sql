...
-- ----------   -------------   --------------------------------------------
-- 2025-04-09   CWD             Initial creation.
-- =========================================================================

PRINT 'Starting Staging Table Creation for MSSQL...';
GO
...
PRINT 'Creating table [stg].[mssql_findings]...';
GO
...
END TRY
BEGIN CATCH
    PRINT 'ERROR: Failed to create table [stg].[mssql_findings].'
...
PRINT 'Staging Table Creation Script Finished.';
GO
